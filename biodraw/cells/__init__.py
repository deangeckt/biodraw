...
What building these two found missing is recorded in `docs/PLAN.md`. In short:
`core.shape.Layer`, because a nucleus has to occlude the body rather than fuse
with it, and `core.scatter`, because nothing here grows along a path.
"""
